...
function Navbar() {
    ...
    return (
        <nav className='max-w-5xl mx-auto mt-5 flex items-center justify-between px-5 overflow-clip'>
            <NavLink to="/" className='font-bold text-xl md:text-3xl'>Sujal Sthapit</NavLink>

            {/* large screen */}
            <div className='hidden md:flex mt-2 bg-gray-900 px-5 py-2 w-fit mx-auto border-2 border-gray-500 rounded-4xl items-center gap-5 text-gray-300 text-md'>
            ...
            <button onClick={()=>setMenu(!menu)}>
                <MenuIcon fontSize='small' className='flex! md:hidden!' />     
            </button>
